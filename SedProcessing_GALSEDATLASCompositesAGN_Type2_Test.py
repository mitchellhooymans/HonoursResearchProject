...
# Save the plot
plt.savefig('outputs/UGRPlots/lacy_wedge_evolution_Type2.png', dpi=300)
...
completeness_df.to_csv('outputs/IRAC_completeness_values_Type2AGN.csv', index=False)

# Plot the completeness values (bar chart)
plt.figure(figsize=(10, 5))
plt.bar(completeness_df['alpha']*100, completeness_df['completeness'])
plt.xlabel('AGN Contribution [%]')
plt.ylabel('Completeness')
plt.title('Completeness of Lacy Wedge with Alpha')
plt.grid()
# Save
plt.savefig('outputs/IRAC_completeness_bar_Type2AGN.png', dpi=300)

plt.show()

# Alternatively line plot
plt.figure(figsize=(10, 5))
plt.plot(completeness_df['alpha']*100, completeness_df['completeness'], marker='o')
plt.xlabel('AGN Contribution [%]')
plt.ylabel('Completeness')
plt.title('Completeness of Lacy Wedge with Alpha')
plt.grid()
# Save
plt.savefig('outputs/IRAC_completeness_line_Type2AGN.png', dpi=300)
plt.show()

# Another scatter plot
plt.figure(figsize=(10, 5))
plt.scatter(completeness_df['alpha']*100, completeness_df['completeness'])
plt.xlabel('AGN Contribution [%]')
plt.ylabel('Completeness')
plt.title('Completeness of Lacy Wedge with Alpha')
plt.grid()
# Save
plt.savefig('outputs/IRAC_completeness_scatter_Type2AGN.png', dpi=300)
plt.show()
...
# Save the table
#completeness_df.to_csv('outputs/IRAC_completeness_table_Type2.csv', index=False)
